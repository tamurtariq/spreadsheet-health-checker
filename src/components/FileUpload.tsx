...
export default function FileUpload({ onAnalyzeComplete, maxFileSize = 50 * 1024 * 1024 }: FileUploadProps) {
  ...
  return (
    <div className="file-upload">
      <div
        className={`drop-zone ${file ? 'has-file' : ''} ${isAnalyzing ? 'analyzing' : ''}`}
      ...
      >
        ...
        {file ? (
          ...
          <div className="drop-prompt">
            ...
            <span className="file-types">CSV, XLSX, XLS • Up to {Math.round(maxFileSize / 1024 / 1024)} MB</span>
